...
#define _DUTY_NEU 1650 // servo neutral position (90 degree)
#define _DUTY_MAX 2640 // servo full counterclockwise position (180 degree)
...
void loop() {
  ...
  dist_ema = (0.3*dist_prev)+(0.7*dist_ema);

  // adjust servo position according to the USS read value
  // add your code here!
  myservo.writeMicroseconds(map(dist_ema,180.0,360.0,_DUTY_MIN,_DUTY_MAX));
